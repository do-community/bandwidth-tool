...
<template>
    <div class="icon">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 38.02 46.96" aria-hidden="true">
            ...
            <g fill="#3681f7">
                <path
                    d="m19 47a19 19 0 0 1 -19-19c0-13.89 17.66-27 18.42-27.56l.58-.44.59.45c.77.55 18.41 14.14 18.41 27.55a19 19 0 0 1 -19 19zm0-44.48c-3.09 2.42-17 13.97-17 25.48a17 17 0 0 0 34 0c0-11.11-13.92-23-17-25.48z"></path>
